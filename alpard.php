	...
	<title>Gabriela Trans | Alphard </title>
...
<div class="container">
	    <div class="row fullscreen d-flex align-items-center justify-content-center">
						    ...
						    <div class="col-lg-5  col-md-6 header-right">
						      ...
						      <form class="form" action="pesan.php" role="form"  autocomplete="off"  method="post">
							    <div class="form-group">
							       	<div class="default-select" id="default-select"  type="text">
										<select name="mobil">
															              <option value="Alphard">Alphard</option>
						              <option value="Avvanza">Avanza</option>
	...
	<div class="col-md-12">
					<div class="input-group dates-wrap">                                              
								...
								<div class="form-group row">
									<div class="col-md-12">
							            <a href="https://wa.me/6281228547149?text=Saya%20ingin%20sewa%20Alphart" class="btn btn-success btn-block text-center text-uppercase">klik jika ingin pesan lewat wa</a>
							        </div>
									</div>
							</form>
					        </div>
