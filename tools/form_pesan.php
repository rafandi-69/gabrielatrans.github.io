		...
		<div class="row fullscreen d-flex align-items-center justify-content-center">
			<div class="banner-content col-lg-7 col-md-6 ">
				...
				<p class="pt-20 pb-20 text-white">
					Sewa / Rental Mobil Terbaik di Semarang Dengan Pelayanan Prima
				</p>
			</div>
			<div class="col-lg-5  col-md-8 header-right">
				<h4 class="text-white pb-29">PILIH MOBIL TERBAIKMU SEKARANG !</h4>
				<form class="form" action="pesan.php" autocomplete="off" method="post">
					...
					<div class="form-group row">
						<div class="col-md-12">
							<h5 class="text-white"> Tanggal Berangkat </h5>
						</div>
					</div>
					<div class="form-group row">
						<div class="col-md-12 ">
					...
					<div class="form-group row">
						<div class="col-md-12">
							<h5 class="text-white"> Waktu Berangkat </h5>
						</div>
					</div>
					<div class="form-group row">
						<div class="col-md-12">
					...
					<div class="form-group row">
						<div class="col-md-12">
							<h5 class="text-white"> Tanggal Pulang </h5>
						</div>
					</div>
					<div class="form-group row">
						<div class="col-md-12">
					...
					<div class="form-group row">
						<div class="col-md-12">
							<a href="https://wa.me/6281228547149?text=Saya%20ingin%20sewa%20mobil" class="btn btn-success btn-block text-center text-uppercase">klik jika ingin pesan lewat wa</a>
						</div>
					</div>
				</form>
			</div>
